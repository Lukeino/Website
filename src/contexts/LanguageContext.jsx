...
const translations = {
  it: {
    ...
    aboutDescription2: "Attualmente possiedo competenze piuttosto versatili nel mio ambito, che spaziano dallo sviluppo di videogiochi allo sviluppo web, dal machine learning alla cyber security.",
    aboutDescription3: "La maggior parte di queste derivano da progetti come solo dev e dal mio percorso di studi.",
